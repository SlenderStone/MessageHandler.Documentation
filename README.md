...
Welcome to [MessageHandler](http://www.messagehandler.net), the online message processing platform. This platform allows you to collect data transmitted in real time (messages), process this data into more valuable information, and respond to this information in any way you like (handle it). 
