...
Our platform enables you to collect transmitted data in real time (messages), process this data into more valuable information (using your own or other's logic), and respond to the resulting information in any way that is appropriate (handle it). 
